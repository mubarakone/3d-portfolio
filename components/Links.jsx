...
export default function SVGComponent({ onPathClick, onHoveredPath }) {
  ...
  const paths = [
    { d: "M533 122H333.404L319 103.474V78H521.683L533 91.8947V122Z", text: "GITHUB", imageSource: "github-logo.png", bottomText: "Text 6" },
    { d: "M533 169H333.404L319 150.474V125H521.683L533 138.895V169Z", text: "LINKEDIN", imageSource: "LinkedIn_logo_initials.png", bottomText: "Text 5" },
    { d: "M533 216H333.404L319 197.474V172H521.683L533 185.895V216Z", text: "RESUME", imageSource: "resume-icon.png", bottomText: "Text 4" },
    { d: "M533 263H333.404L319 244.474V219H521.683L533 232.895V263Z", text: "OLD WEBSITE", imageSource: "website-icon-2048x2048-ax2y60lj.png", bottomText: "Text 3" },
        ...
        return (
          <>
            <a
              ...
              rel="noopener noreferrer"  // Adds security
            >
              https://www.linkedin.com/in/mubarak-usmane/
            </a>
          </>
        );
      case 2:
