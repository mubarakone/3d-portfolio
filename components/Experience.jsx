...
export default function SVGComponent({ onPathClick, onHoveredPath }) {
  ...
  const paths = [
    { d: "M533 122H333.404L319 103.474V78H521.683L533 91.8947V122Z", text: "NETHERMIND", imageSource: "nethermind_logo.png", bottomText: "Text 6" },
    { d: "M533 169H333.404L319 150.474V125H521.683L533 138.895V169Z", text: "WALLETCONNECT", imageSource: "walletconnect-logo.png", bottomText: "Text 5" },
    { d: "M533 216H333.404L319 197.474V172H521.683L533 185.895V216Z", text: "MORALIS", imageSource: "Moralis-Glass-Favicon.svg", bottomText: "Text 4" },
    { d: "M533 263H333.404L319 244.474V219H521.683L533 232.895V263Z", text: "TRAIL OF BITS", imageSource: "trailofbits-logo.png", bottomText: "Text 3" },
          ...
          <>
            <div
              style={{
                ...
                position: 'absolute',
                top: '345px', // Adjust this to position it correctly (based on bottom red circle)
                right: '220px', // Adjust this to position it correctly
                color: '#FFFFFF',
                fontSize: '10px',
                whiteSpace: 'nowrap',
              }}
            ...
            <div
              style={{
                ...
                right: '350px', // Adjust this to position it correctly
                color: '#FFFFFF',
                fontSize: '18px',
                fontWeight: 600,
                whiteSpace: 'nowrap',
            ...
            <div
              style={{
                ...
                right: '210px', // Adjust this to position it correctly
                color: '#FFFFFF',
                fontSize: '14px',
                whiteSpace: 'nowrap',
              }}
            >
              • Worked on a DeFi project<br />
              • Responsible for Web2-Web3 intergrations<br />
              • Next, TypeScript, JavaScript, Firebase Authentication
            </div>
          </>
        );
      case 1:
          ...
          <>
            ...
            <div
              style={{
                ...
                position: 'absolute',
                top: '340px', // Adjust this to position it correctly (based on bottom red circle)
                right: '360px', // Adjust this to position it correctly
                color: '#FFFFFF',
                fontSize: '18px',
                fontWeight: 600,
                whiteSpace: 'nowrap',
            ...
            <div
              style={{
                ...
                position: 'absolute',
                top: '390px', // Adjust this to position it correctly (based on bottom red circle)
                right: '230px', // Adjust this to position it correctly
                color: '#FFFFFF',
                fontSize: '14px',
                whiteSpace: 'nowrap',
              }}
            >
              • Provided support for developers integrating clients<br />
              • Troubleshooting issues for applications<br />
              • Via Discord, GitHub, Reddit, StackOverflow
            </div>
          </>
        );
      case 2:
          ...
          <>
            ...
            <div
              style={{
                ...
                position: 'absolute',
                top: '340px', // Adjust this to position it correctly (based on bottom red circle)
                right: '380px', // Adjust this to position it correctly
                color: '#FFFFFF',
                fontSize: '18px',
                fontWeight: 600,
                whiteSpace: 'nowrap',
            ...
            >
              • Frequent DAO member<br />
              • Contributed on web3uikit and ethereum-boilerplate<br />
              • Used Moralis for many freelance projects
            </div>
          </>
        );
      case 3:
          return (
            ...
            >
              BLOCKCHAIN SECURITY<br />ANALYST APPRENTICE
            </div>
            <div
              style={{
                fontFamily: 'Roboto, sans-serif',
            ...
            >
              • 3-month apprenticeship program<br />
              • Reviewing Solidity-based smart contracts<br />
              • Mentored while fuzzing vulnerabilities and exploits
            </div>
          </>
          )
      case 4:
        ...
        index !== 4 && ( // Exclude the element with index 4
          <div
            ...
            style={{
              ...
              right: '100px', // Adjust to align with SVG path
